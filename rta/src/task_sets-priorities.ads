...
--                             RTA COMPONENTS                               --
--                                                                          --
--                    TASK_SETS.PRIORITIES Specification                    --
--                                                                          --
--                             $Revision: 1.2 $                             --
--                                                                          --
...
-- (DIT/UPM).                                                               --
------------------------------------------------------------------------------
-- priority assigment procedures
------------------------------------------------------------------------------
package Task_Sets.Priorities is

   procedure Compute_Task_Priorities   (Set   : in out Task_Set);
   procedure Compute_Priority_Ceilings (Set : in out Task_Set);
